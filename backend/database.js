...
function saveRooms(lernflixroomid, lernflixroomname, moodleroomid, moodleroomname) {
    ...
    client.query(`INSERT INTO rooms(lernflixroomid, lernflixroomname, moodleroomid, moodleroomname) SELECT $1, $2, $3, $4 WHERE NOT EXISTS (SELECT * FROM rooms WHERE lernflixroomname = $2)`, [lernflixroomid, lernflixroomname, moodleroomid, moodleroomname], (err, res) => {
        if (err) {
